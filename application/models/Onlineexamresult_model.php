...
class Onlineexamresult_model extends CI_Model
{
    ...
    {
        $this->db->select('`onlineexam_student_results`.*, onlineexam_questions.marks  as `question_marks`,onlineexam_questions.neg_marks  as `question_neg_marks`,`onlineexam_questions`.`question_id`, `questions`.`question`, questions.id as `q_id`, `questions`.`question_type`,`onlineexam_students.student_session_id`,`student_session.student_id`, `student_session.student_id`,`students.firstname`,`students.middlename`,`students.lastname`,`students.mobileno`, `students.email`,`students.admission_no`, `students.guardian_name`,`students.guardian_relation`,`students.guardian_phone`,`students.guardian_address`, `students.roll_no`,`students.admission_date`,`classes.class`,`sections.section`')->from('onlineexam_student_results');
