...
class Student_model extends MY_Model
{
    ...
    public function getold($id = null)
    {
    ...
    {
        $this->db->select('student_session.transport_fees,students.app_key,students.parent_app_key,students.vehroute_id,vehicle_routes.route_id,vehicle_routes.vehicle_id,transport_route.route_title,vehicles.vehicle_no,hostel_rooms.room_no,vehicles.driver_name,vehicles.driver_contact,hostel.id as `hostel_id`,hostel.hostel_name,room_types.id as `room_type_id`,room_types.room_type ,students.hostel_room_id,student_session.id as `student_session_id`,student_session.fees_discount,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section,students.id,students.admission_no , students.roll_no,students.student_adhar_no,students.subjects,students.pan_card,students.mother_adhar_no,students.mother_pan_card,students.father_adhar_no,students.father_pan_card,students.admission_date,students.firstname,students.middlename,  students.lastname,students.image,    students.mobileno, students.email ,students.state ,   students.city , students.pincode , students.note, students.religion, students.cast, school_houses.house_name,   students.dob ,students.current_address, students.previous_school,
            students.guardian_is,students.parent_id,
            students.permanent_address,students.category_id,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code , students.guardian_name , students.father_pic ,students.height ,students.weight,students.measurement_date, students.mother_pic , students.guardian_pic , students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.school_house_id,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.gender,students.guardian_is,students.rte,students.guardian_email, users.username,users.password,students.dis_reason,students.dis_note,students.disable_at,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
    ...
    public function searchByGender($gender = null)
    {
    ...
    public function zendget($id = null)
    {
        $this->db->select('students.updated_at AS `dateLastModified`,students.admission_no AS `identifier`,students.firstname AS `studentFirstName`,students.lastname AS studentLastName`,students.gender,students.email,students.mobileno AS `phone`,classes.class AS `currentClass`,students.guardian_name AS `parentfullName`, students.father_name AS `parentFirstName` ,   students.city , students.pincode , students.note, students.religion, students.cast,student_session.id as `student_session_id`,classes.id AS `class_id`,sections.section, students.roll_no,students.student_adhar_no,students.subjects,students.pan_card,students.mother_adhar_no,students.mother_pan_card,students.father_adhar_no,students.father_pan_card,students.admission_date, school_houses.house_name,   students.dob ,students.current_address, students.previous_school,
            students.guardian_is,students.parent_id,
            students.permanent_address,students.category_id,students.adhar_no,students.samagra_id, students.measurement_date, students.mother_pic , students.guardian_pic , students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.guardian_is,students.guardian_email, students.dis_reason,students.dis_note,students.disable_at,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
        ...
        if ($id != null) {
            ...
            $this->db->or_where('students.mobileno', $id);
            $this->db->or_where('students.email', $id);
        } else {
            $this->db->where('students.is_active', 'yes');
            $this->db->order_by('students.id', 'desc');
        }
    ...
    //===========
      ...
      public function zendgetfilter($id = null)
    {
        $this->db->select('students.id AS `student_id ,students.updated_at AS `dateLastModified`,students.admission_no AS `identifier`,students.firstname AS `studentFirstName`,students.lastname AS studentLastName`,students.gender,students.email,students.mobileno AS `phone`,classes.class AS `currentClass`,students.guardian_name AS `parentfullName`, students.father_name AS `parentFirstName` ,   students.city , students.pincode , students.note, students.religion, students.cast,student_session.id as `student_session_id`,classes.id AS `class_id`,sections.section, students.roll_no,students.student_adhar_no,students.subjects,students.pan_card,students.mother_adhar_no,students.mother_pan_card,students.father_adhar_no,students.father_pan_card,students.admission_date, school_houses.house_name,   students.dob ,students.current_address, students.previous_school,
            students.guardian_is,students.parent_id,
            students.permanent_address,students.category_id,students.adhar_no,students.samagra_id, students.measurement_date, students.mother_pic , students.guardian_pic , students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.guardian_is,students.guardian_email, students.dis_reason,students.dis_note,students.disable_at,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
