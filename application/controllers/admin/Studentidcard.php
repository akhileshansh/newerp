...
class studentidcard extends Admin_Controller {
    ...
    public function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->input->post('is_active_rfid_card_group') == 1) {
                $rfid_card = $this->input->post('is_active_rfid_card_group');
            }
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $enable_vertical_card=$this->input->post('enable_vertical_card');
             if (isset($enable_vertical_card)) {
              ...
              if ($this->input->post('enable_rfid_card') == 1) {
                $rfid_card = $this->input->post('enable_rfid_card');
            }
