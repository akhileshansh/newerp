...
<html <?php echo $this->customlib->getRTL(); ?>>
    <head>
       ...
       <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo();?>" rel="shortcut icon" type="image/x-icon">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/dist/css/custome.css"> 
 ...
 <div class="topaleart">
   ...
   <p class="palert"><strong>Alert!</strong> You are using unregistered version of Schoolsdunia. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for Schoolsdunia.</p>
</div></div>
</div> 
<script>
