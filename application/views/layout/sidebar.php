<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                <a href="#">
                    <i class="fa fa-inr ftlayer"></i> <span> <?php echo $this->lang->line('fees_collection'); ?></span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    ...
                    if ($this->rbac->hasPrivilege('zenda_payment', 'can_view')) {
                            ?>
                    <li class="<?php echo set_Submenu('studentfee/zendapayment'); ?>"><a
                            href="<?php echo site_url('studentfee/zendapayment'); ?>"><i
                                class="fa fa-angle-double-right"></i>
                            <?php echo $this->lang->line('pay_with') . " " . $this->lang->line('zenda'); ?></a>
                    </li>
                      <?php
                            } ?>      
            ...
            <li class="treeview <?php echo set_Topmenu('Income'); ?>">
                <a href="#">
                    <i class="fa fa-inr ftlayer"></i> <span><?php echo $this->lang->line('income'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php
                                 ...
                                 if ($this->module_lib->hasActive('rfid')) {
                if ($this->rbac->hasPrivilege('rfid', 'can_view')) {
                                ?>
                    <li class="<?php echo set_Submenu('stuattendence/rfid'); ?>"><a
                            href="<?php echo base_url(); ?>admin/stuattendence/rfid"><i
                                class="fa fa-angle-double-right"></i>
                            <?php echo $this->lang->line('rfid'); ?></a></li>
            ...
            <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('Examinations/reportcard'); ?>"><a
                            href="<?php echo base_url(); ?>/reportcard"><i class="fa fa-angle-double-right"></i>
                          Student Report Card</a></li> 
    ...
    ?>
            ...
            ?>
            <?php
            if ($this->module_lib->hasActive('gmeet')) {
                if (($this->rbac->hasPrivilege('gmeet', 'can_view'))) {
            ?>
            <li class="treeview <?php echo set_Topmenu('gmeet'); ?>">
                <a href="<?php echo base_url(); ?>admin/gmeet">
                    <i class="fa fa-sitemap ftlayer"></i> <span><?php echo $this->lang->line('g_meet'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <?php
                }
...
online_course_offline_payment', 'can_view')) ||
            ...
            <li class="treeview <?php echo set_Topmenu('alumni'); ?>" style="display: none;">
                <a href="#">
            ...
            <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php
                            ...
                            if ($this->rbac->hasPrivilege('superadmin')) {
                            ?>
                    <li class="<?php echo set_Submenu('System Settings/updater'); ?>" style="display: none"><a
