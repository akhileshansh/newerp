    ...
    if (($this->rbac->hasPrivilege('collect_fees', 'can_view') ||
        ...
        ?>
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        <a href="#">
                            <i class="fa fa-inr ftlayer"></i> <span> <?php echo $this->lang->line('fees_collection'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('superadmin')) {
            ?>
                                <li class="<?php echo set_Submenu('System Settings/updater'); ?>" style="display: none"><a href="<?php echo base_url(); ?>admin/updater"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('system_update') ?></a></li>
                        <?php
}
