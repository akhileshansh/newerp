                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_rfid_card" name="enable_rfid_card" type="checkbox" class="chk" value="1" <?php echo set_checkbox('rfid_card', '1', (set_value('enable_rfid_card', $editidcard[0]->enable_rfid_card) == 1) ? TRUE : FALSE); ?>>
                                        <label for="enable_rfid_card" class="label-success"></label>
                                    </div>
                                </div>
                                    <div class="form-group switch-inline">
