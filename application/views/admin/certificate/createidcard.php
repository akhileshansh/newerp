                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/studentidcard/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('rfid_card'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="enable_rfid_card_group" name="is_active_rfid_card_group" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_rfid_card_group', '1', (set_value('is_active_rfid_card_group') == 1) ? TRUE : FALSE); ?>>
                                        <label for="enable_rfid_card_group" class="label-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
