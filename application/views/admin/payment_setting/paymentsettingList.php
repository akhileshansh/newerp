                ...
                <div class="nav-tabs-custom box box-primary theme-shadow">
                    ...
                    <ul class="nav nav-tabs nav-tabs2">
                      <!--   <li class="active"><a href="#tab_1" data-toggle="tab"><?php echo $this->lang->line('paypal');?></a></li>
                        ...
                        <li class="active"><a href="#tab_7" data-toggle="tab"><?php echo $this->lang->line('razorpay'); ?></a></li>
                        <li><a href="#tab_8" data-toggle="tab"><?php echo $this->lang->line('zenda'); ?></a></li>
                        ...
                        <li><a href="#tab_16" data-toggle="tab"><?php echo $this->lang->line('cashfree'); ?></a></li>
                    </ul> 
                    <div class="tab-content pb0">
                        ...
                        <div class="tab-pane" id="tab_8">
                            <form role="form" id="zenda" action="<?php echo site_url('admin/paymentsettings/zenda') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                            <div class="col-md-7">
                                                <?php
                                                $paytm_result = check_in_array('zenda', $paymentlist);
                                                ?> 
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('Zenda_website'); ?>
                                                        <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.zenda.com/" target="_blank">
                                                    <h5><?php echo $this->lang->line('payment_gateway');?></h5>
                                                    <img src="<?php echo base_url(); ?>/backend/images/zenda.png" width="200"><p>https://www.zenda.com</p></a>
                                            </div>
                                    </div>
                                </div> 
                                <!-- /.box-body -->
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                <button type="submit" class="btn btn-primary zenda_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                            <?php } ?>
                                        </div>
                                    </div>        
                                </div>
                        ...
                        <div class="tab-pane" id="tab_9" style="display:none;">
                          ...
                          <div class="tab-pane " id="tab_10" style="display:none;">
                         ...
                         <div class="tab-pane " id="tab_11" style="display:none;">
                        ...
                        <div class="tab-pane " id="tab_12" style="display:none;">
                        ...
                        <div class="tab-pane " id="tab_13" style="display:none;">
                         ...
                         <div class="tab-pane " id="tab_14" style="display:none;">
                         ...
                         <div class="tab-pane " id="tab_15" style="display:none;">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                        ...
                                                        <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="cashfree_merchantid" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($cashfree_result->api_publishable_key) ? $cashfree_result->api_publishable_key : ""; ?>" />
                                                        <span class=" text text-danger cashfree_merchantid_error"></span>
                                                    </div>  </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('client_secret'); ?>
                                                        <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="cashfree_merchantkey" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($cashfree_result->api_secret_key) ? $cashfree_result->api_secret_key : ""; ?>" />
                                                        <span class=" text text-danger cashfree_merchantkey_error"></span>
                                                    </div>
                                                </div>
                                                   <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                        ...
                                                        <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="cashfree_website" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($cashfree_result->paytm_website) ? $cashfree_result->paytm_website : ""; ?>" />
                                                        <span class=" text text-danger cashfree_website_error"></span>
                                                    </div> 
                                                     </div>
                                            </div>
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.cashfree.com/" target="_blank">
                                                    <h5><?php echo $this->lang->line('payment_gateway_for_india');?></h5>
                                                    <img src="<?php echo base_url(); ?>/backend/images/cashfree.png" width="200"><p>https://www.cashfree.com</p></a>
                                            </div>
                                    </div>
                                </div> 
                                <!-- /.box-body -->
                    ...
                    <form role="form" action="<?php echo site_url('admin/paymentsettings/setting') ?>" id="payment_gateway" method="POST">
                        <div class="box-body minheight199">
                            <div class="form-group"> <!-- Radio group !-->
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio"  name="payment_setting" value="zenda" <?php
                                        if ($radio_check == 'zenda') {
                                            echo "checked";
                                        }
                                        ?>>
                                        <?php echo $this->lang->line('zenda'); ?>
                                    </label>
                                </div>
