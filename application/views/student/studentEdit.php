                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php } else{ ?>
                                                ...
                                                <input   id="admission_no" name="admission_no" placeholder="" type="hidden" class="form-control"  value="<?php echo set_value('admission_no', $student['admission_no']); ?>" />
                                     <?php   } if ($sch_setting->roll_no) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="subjects" name="subjects" placeholder="Math,Physics" type="text" class="form-control"  value="<?php echo set_value('subjects', $student['subjects']); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('adhar_no'); ?></label>
                                                <input id="student_adhar_no" name="student_adhar_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('student_adhar_no', $student['student_adhar_no']); ?>" />
                                                <span class="text-danger"><?php echo form_error('student_adhar_no'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('pan_card'); ?></label>
                                                <input id="pan_card" name="pan_card" placeholder="" type="text" class="form-control"  value="<?php echo set_value('pan_card', $student['pan_card']); ?>" />
                                                <span class="text-danger"><?php echo form_error('pan_card'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<?php }if ($sch_setting->father_pic) { ?>
                                        ...
                                        <?php } ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('father_adhar_no'); ?></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('father_pan_card'); ?></label>
                                                    <input id="father_pan_card" name="father_pan_card" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_pan_card', $student['father_pan_card']); ?>" />
                                                    <span class="text-danger"><?php echo form_error('father_pan_card'); ?></span>
                                                </div>
                                            </div>
                                    </div>
...
<?php } ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('mother_adhar_no'); ?></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('mother_pan_card'); ?></label>
                                                    <input id="mother_pan_card" name="mother_pan_card" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_pan_card', $student['mother_pan_card']); ?>" />
                                                    <span class="text-danger"><?php echo form_error('mother_pan_card'); ?></span>
                                                </div>
                                            </div>
                                    </div>
