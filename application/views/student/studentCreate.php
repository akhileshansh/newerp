                                        ...
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="subjects" name="subjects" placeholder="Math,Physics" type="text" class="form-control"  value="<?php echo set_value('subjects'); ?>" />
                                        ...
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="adhar_no" name="student_adhar_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('student_adhar_no'); ?>" />
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pan_card" name="pan_card" placeholder="" type="text" class="form-control "  value="<?php echo set_value('pan_card'); ?>" />
...
<?php } ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_adhar_na" name="father_adhar_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_adhar_no'); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_pan_card" name="father_pan_card" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_pan_card'); ?>" />
...
<?php } ?>
                                              <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_adhar_na" name="mother_adhar_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_adhar_no'); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_pan_card" name="mother_pan_card" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_pan_card'); ?>" />
