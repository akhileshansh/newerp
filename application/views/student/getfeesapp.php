                                                    ...
                                                    <td>
                                                        <div class="btn-group pull-right"> 
                                                            ...
                                                            if ($payment_method) {
                                                                ...
                                                                if ($feetype_balance > 0) {
                                                                    ?>
                                                                    <a href="<?php echo base_url() . 'cronjob/payment/' . $fee->id . "/" . $fee_value->fee_groups_feetype_id . "/" . $student['id'] ?>" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-money"></i>  <?php echo $this->lang->line('pay'); ?></a>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
...
<script type="text/javascript">
       ...
       $("#select_all").change(function () {  //"select all" change 
        ...
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length === 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("cronjob/printFeesByGroupArray") ?>',
                    type: 'post',
  ...
  $(document).on('click', '.collectSelected', function () {
            ...
            if(select_count > 0){
                $.ajax({
                type: 'POST',
                url: base_url + "cronjob/getcollectfee",
