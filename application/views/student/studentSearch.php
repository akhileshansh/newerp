                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row ">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group inlinebtns">

                                                <button type="submit" name="search" value="search_full" class="btn btn-primary mt-2 pull-right btn-sm checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="gender_id" name="gender" class="form-control" >
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <option value="Male">Male</option>
                                                    <option value="Female">Female</option> 
                                                </select>
                                                  <span class="text-danger" id="error_gender_id"></span>
                                            </div>
                                        </div>
                                        
                                        <div class="col-sm-2 ">
                                            <div class="form-group inlinebtns">
                                                <button type="submit" name="search" value="search_gender" class="btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                            </div>
                                        </div>
                                </div>
                            </div><!--./col-md-12-->
